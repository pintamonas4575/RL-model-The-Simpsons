...
"""**********************************************************"""
my_env = Scratch_Game_Environment4(frame_size=50, scratching_area=(110,98,770,300))
...
path_to_save = f"V4_version/V4_1_Qtable_{my_env.total_squares}_{EPISODES}"
...
for i in range(EPISODES):
    ...
    current_state = agent.game_env.frames_mask  # the state is 
